...
NEW_test.Labels=ALL_IMG.Labels([L1_ind_tst]);
       ...
       [ind_TAB,new_TAB,new_ind]=extend_train(NEW_train.Labels,classes_star);
...
[TAB_val,TAB_trn]=check_accuracy(NEW_test.Labels,YPred,classes_star,NEW_train.Labels,YTrain);
